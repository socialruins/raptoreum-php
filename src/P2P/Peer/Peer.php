...
class Peer extends EventEmitter
{
    ...
    /**
     * @var \Raptorio\Blockchain\P2P\Messages\Factory
     */
    private $msgs;
    ...
    /**
     * @param \Raptorio\Blockchain\P2P\Messages\Factory $msgs
     * @param LoopInterface $loop
     */
    public function __construct(\Raptorio\Blockchain\P2P\Messages\Factory $msgs, LoopInterface $loop)
    {
        $this->msgs = $msgs;
        $this->loop = $loop;
    }
